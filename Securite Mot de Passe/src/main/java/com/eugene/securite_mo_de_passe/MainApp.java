package com.eugene.securite_mo_de_passe;

import java.awt.*;
import java.io.IOException;

import com.eugene.securite_mo_de_passe.model.Securite;
import com.eugene.securite_mo_de_passe.view.SecuriteOverviewController;
...
public class MainApp extends Application {
    ...
    public void initRootLayout() {
        try {
            ...
            loader.setLocation(
                    MainApp.class.getResource("/com/eugene/securite_mo_de_passe/view/SecuriteRootLayout.fxml"));
            ...
            // récuperer la dimension de l'écran et regle la position de l'application a 1/2
            // de l'espasce qu'il y a entre elle et l'ecran
    ...
    public void showSecuriteOverview() {
        try {
            ...
            FXMLLoader loader = new FXMLLoader();
            loader.setLocation(
                    MainApp.class.getResource("/com/eugene/securite_mo_de_passe/view/SecuriteOverview.fxml"));
